 ...
 ##Change 3/9/2022 Removed the sys.objects reference as the service would required high privilege access to see those objects##   
...
##"/*Removed object_name(nodspstats.object_id) AS 'procname' as it would require too much permissions most environments will not approve. You will have to cross reference the object ID manually on the DW instance## */##
$SqlCmd = New-Object System.Data.SqlClient.SqlCommand
